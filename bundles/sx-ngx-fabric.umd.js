(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/cdk/portal'), require('@angular/platform-browser'), require('@angular/cdk/overlay'), require('rxjs/Subject'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/take'), require('rxjs/Subscription')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/cdk/portal', '@angular/platform-browser', '@angular/cdk/overlay', 'rxjs/Subject', 'rxjs/add/operator/filter', 'rxjs/add/operator/take', 'rxjs/Subscription'], factory) :
	(factory((global['sx-ngx-fabric'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.ng.cdk.portal,global.ng.platformBrowser,global.ng.cdk.overlay,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx));
}(this, (function (exports,core,common,forms,portal,platformBrowser,overlay,Subject,filter,take,Subscription) { 'use strict';
...
ToggleComponent.propDecorators = {
    ...
    'textLeft': [{ type: core.Input },],
    'classIsDisabled': [{ type: core.HostBinding, args: ['class.is-disabled',] },],
    'classTextLeft': [{ type: core.HostBinding, args: ['class.ms-Toggle--textLeft',] },],
};
...
ButtonComponent.propDecorators = {
    ...
    'classes': [{ type: core.HostBinding, args: ['class.ms-Button',] },],
...
CalloutComponent.propDecorators = {
    ...
    'beak': [{ type: core.ViewChild, args: ['beak',] },],
...
var CalloutTriggerDirective = (function () {
    /**
     * @param {?} _overlay
     * @param {?} _element
    ...
    CalloutTriggerDirective.prototype._getOverlayConfig = function () {
        var /** @type {?} */ position = this._getPosition();
    ...
    CalloutTriggerDirective.prototype._getPosition = function () {
        var _d = this.callout.xPosition === 'before' ? ['end', 'start'] : ['start', 'end'], originX = _d[0], originFallbackX = _d[1];
        var _e = this.callout.yPosition === 'above' ? ['bottom', 'top'] : ['top', 'bottom'], overlayY = _e[0], overlayFallbackY = _e[1];
    ...
    CalloutTriggerDirective.prototype._subscribeToPositions = function (position) {
        ...
        this._positionSubscription = position.onPositionChange
            .pipe(distinctUntilChanged(null, function (x) { return x.connectionPair; }))
            .subscribe(function (pos) {
            var /** @type {?} */ isCalloutUnderTrigger = pos.connectionPair.overlayY === 'top';
            var /** @type {?} */ isCalloutLeftAlignedToTrigger = pos.connectionPair.overlayX === 'start';
            var /** @type {?} */ triggerMiddle = _this._portal.viewContainerRef.element.nativeElement.offsetWidth / 2 - 14;
...
CalloutTriggerDirective.propDecorators = {
    'sxNgxFabricCalloutTrigger': [{ type: core.Input },],
};
...
exports.ɵu = CalloutTriggerDirective;
exports.ɵt = CalloutComponent;
exports.ɵs = CalloutModule;
...
exports.ɵw = NavComponent;
exports.ɵv = NavModule;
